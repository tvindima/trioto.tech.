(() => {
  const translations = {
    en: {
      ...
      warningTitle: "Think twice before scanning this QR code.",
      warningBody: "It may connect you with two people who see technology differently: protect first, validate fast, scale only what matters.",
    ...
    pt: {
      ...
      warningTitle: "Pensa duas vezes antes de ler este QR code.",
      warningBody: "Pode colocar-te em contacto com duas pessoas que veem a tecnologia de forma diferente: proteger primeiro, validar rápido, escalar apenas o que importa.",
      whatsappTiago: "WhatsApp Tiago",
      whatsappVitor: "WhatsApp Vítor",
